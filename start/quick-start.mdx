...
---
<Tip>
  本指南将帮助您快速上手节点跃迁大模型平台，从注册账号到发起第一次 API 调用，只需几分钟即可完成。
</Tip>
...
<Steps>
  <Step title="注册账号">
    访问[节点跃迁大模型平台](https://www.fcloud.net/)，点击右上角的「注册/登录」按钮，按照提示完成账号注册流程。

    <Frame>
      ![注册账号](https://download.fcloud.net/directlink/2/api-docs/ScreenShot_2026-02-06_161608_972.png)
    </Frame>
  </Step>

  <Step title="获取API Key">
    登录后，在创建令牌页面，点击 [API Keys](https://www.fcloud.net/console/token)，创建一个新的 API Key。
    ...
    <Frame>
      ![获取 API Key](https://download.fcloud.net/directlink/2/api-docs/ScreenShot_2026-02-03_100550_511.png)
    </Frame>
  </Step>
